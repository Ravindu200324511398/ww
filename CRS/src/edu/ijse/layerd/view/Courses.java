        ...
        if (seatsAvailable > 0) {
            try {
                ...
                if (enrollmentController.enrollStudent(StudentID, CourseID)) {
                    ...
                    // Open the Registered Courses View
                    new RegisteredCourses(StudentID).setVisible(true);
                    this.dispose(); // Close the current Courses window
        ...
        if (seatsAvailable > 0) {
            try {
                ...
                if (enrollmentController.enrollStudent(StudentID, CourseID)) {
                    ...
                    boolean updated = courseDetailsController.updateCourseCapacity(CourseID, seatsAvailable - 1);
...
public boolean updateCourseCapacity(String courseID, int newCapacity) {
    String query = "UPDATE courses SET MaxEnrollmentCapacity = ? WHERE CourseID = ?";
